...
<body>
	...
	<form method="POST" action="/TARACO/ADVRegistServlet">
		<table class="edit_table">
			...
			<tr>
				<td colspan="4"><textarea name="adv_content" cols="65" rows="6">${e.adv_content}</textarea>
				</td>
			</tr>
		</table>
		<input type="submit" name="REGIST" value="新規登録" class="submit"><br>
	</form>
	<br>
